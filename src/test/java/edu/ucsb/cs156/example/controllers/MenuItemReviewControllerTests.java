...
public class MenuItemReviewControllerTests extends ControllerTestCase {
    ...
    public void logged_in_user_can_get_all_menuitemreviews() throws Exception {
        ...
        MvcResult response = mockMvc.perform(get("/api/MenuItemReview/all")).andExpect(status().isOk()).andReturn();
    ...
    public void test_getById_returns_review_if_it_exists() throws Exception {
        ...
        MvcResult response = mockMvc.perform(get("/api/MenuItemReview?id=7")).andExpect(status().isOk()).andReturn();
    ...
    public void test_getById_returns_404_if_it_does_not_exist() throws Exception {
        ...
        MvcResult response = mockMvc.perform(get("/api/MenuItemReview?id=7")).andExpect(status().isNotFound()).andReturn();
